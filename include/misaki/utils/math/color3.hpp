...
class TColor3 {
 public:
  ...
  constexpr TColor3() noexcept : r(0), g(0), b(0) {}

  constexpr TColor3(Value r, Value g, Value b) noexcept : r(r), g(g), b(b) {}

  constexpr TColor3(Value r) noexcept : r(r), g(r), b(r) {}

  constexpr TColor3(const TVector3<Value> &vec) noexcept : r(vec.x), g(vec.y), b(vec.z) {}

  template <typename T, std::enable_if_t<std::is_arithmetic_v<T>, int> = 0>
  constexpr TColor3(const TColor3<T> &col) noexcept : r(Value(col.r)), g(Value(col.g)), b(Value(col.b)) {}
...
// Unary operation
template <typename Value>
TColor3<Value> operator-(const TColor3<Value> &col) noexcept {
  return TColor3<Value>(-col.r, -col.g, -col.b);
}

// Binary operation
template <typename Value>
TColor3<Value> operator+(const TColor3<Value> &lhs, const TColor3<Value> &rhs) noexcept {
...
TColor3<Value> operator+(const TColor3<Value> &lhs, T rhs) noexcept {
