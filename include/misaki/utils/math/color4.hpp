...
class TColor4 {
 public:
  ...
  constexpr TColor4() noexcept : r(0), g(0), b(0), a(0) {}

  constexpr TColor4(Value r, Value g, Value b, Value a) noexcept : r(r), g(g), b(b), a(a) {}

  constexpr TColor4(Value r) noexcept : r(r), g(r), b(r), a(r) {}

  constexpr TColor4(const TColor3<Value> &col) noexcept : r(col.r), g(col.g), b(col.b), a(Value(1)) {}

  constexpr TColor4(const TVector4<Value> &vec) noexcept : r(vec.x), g(vec.y), b(vec.z), a(vec.w) {}

  template <typename T, std::enable_if_t<std::is_arithmetic_v<T>, int> = 0>
  constexpr TColor4(const TColor4<T> &col) noexcept : r(Value(col.r)), g(Value(col.g)), b(Value(col.b)), a(Value(col.a)) {}
  ...
  TColor3<Value> divide_by_alpha() const {
    if (a != 0) {
...
// Unary operation
template <typename Value>
TColor4<Value> operator-(const TColor4<Value> &col) noexcept {
  return TColor4<Value>(-col.r, -col.g, -col.b, -col.a);
}

// Binary operation
template <typename Value>
TColor4<Value> operator+(const TColor4<Value> &lhs, const TColor4<Value> &rhs) noexcept {
...
TColor4<Value> operator+(const TColor4<Value> &lhs, T rhs) noexcept {
